package id.kardihaekal.mp3player;
...
import id.kardihaekal.mp3player.adapters.AlbumsAdapter;
import id.kardihaekal.mp3player.adapters.ArtistsAdapter;
import id.kardihaekal.mp3player.adapters.ColorsAdapter;
import id.kardihaekal.mp3player.adapters.SongsAdapter;
import id.kardihaekal.mp3player.loaders.ArtistProvider;
import id.kardihaekal.mp3player.models.Album;
import id.kardihaekal.mp3player.models.Artist;
import id.kardihaekal.mp3player.models.Song;
import id.kardihaekal.mp3player.playback.EqualizerUtils;
import id.kardihaekal.mp3player.playback.MusicNotificationManager;
import id.kardihaekal.mp3player.playback.MusicService;
import id.kardihaekal.mp3player.playback.PlaybackInfoListener;
import id.kardihaekal.mp3player.playback.PlayerAdapter;
import id.kardihaekal.mp3player.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
  ...
  private void getViews() {
    ...
    mControlsContainer.setBackgroundColor(
        ColorUtils.setAlphaComponent(ContextCompat.getColor(this, mAccent), 10));
