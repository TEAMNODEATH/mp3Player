...
public class Utils {
    ...
    private static final String ACCENT_PREF = "id.kardihaekal.mp3player.pref_accent";
    private static final String ACCENT_VALUE = "id.kardihaekal.mp3player.pref_accent_value";
    private static final String THEME_PREF = "id.kardihaekal.mp3player.pref_theme";
    private static final String THEME_VALUE = "id.kardihaekal.mp3player.pref_theme_value";
